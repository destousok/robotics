function  [fi]= MultipleObstacles(num_obs_rob,P_Obs_all,radius_Obs_all,u_Obs_all,Goal,radius_robot,P_Robot,v_Robot,gama,ro)
...
for i = 1: num_obs_rob
    ...
    sum_m = m + sum_m;
    e = trialPF(P_Robot,Goal,P_Obs_all(i,:),r_security);
...
if sum_m ~= 0
    ...
    fi = trialPF(P_Robot,Goal,P_Obs_all(index_min,:),radius_robot + radius_Obs_all(index_min)); 
    %fi = 0;
end
